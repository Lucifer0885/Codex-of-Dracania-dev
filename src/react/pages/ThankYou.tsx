        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="max-w-[400px] text-center flex flex-col gap-4">
            ...
            <p className="text-gray-400">
              Your support helps us make Drakensang Utils even better for you and everyone else.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            <div
              className="flex items-center gap-2 text-gray-400 btn btn-outline btn-primary w-[150px]"
              onClick={() => window.electron.openExternal("https://discord.gg/drakensang")}
            >
              <svg
            ...
            <div
              className="flex items-center gap-2 text-gray-400 btn btn-dash btn-primary w-[150px]"
              onClick={() => window.electron.openExternal("https://github.com/Lucifer0885")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
